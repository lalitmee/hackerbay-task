...
describe("User Login", function() {
    it("It should return the token of username and password", function(done) {
        chai
            .request(server)
            .post(login)
            .send({ username: "lalit", password: "lalit" })
            .end(function(err, res) {
...
describe("authorize", function() {
    ...
    it("should return error if token is invalid", function(done) {
        let invalidToken =
            "eyJhbGciOiJIUzI1NiIsIqR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFuaWwiLCJwYXNzd29yZCI6Imhkc2ZkcyIsImlhdCI6MTUwNjgwMTEzMn0.y05aZEHqVdjgU2A6Oi8UuufNGy5IGfjdS2N3Jw0cINI";
        chai
            .request(server)
            .post("/authorize")
