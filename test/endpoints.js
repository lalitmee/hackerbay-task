...
let patch = "/api/patch";
let token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImxhbGl0IiwicGFzc3dvcmQiOiJsYWxpdCIsImlhdCI6MTUxODk3MjE0OH0.DVunGKusnzUm6teNNz5UGMZ1OXh6USFRU09SAaxO6zA";
let invalidToken =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFubWwiLCJwYXNzd29yZCI6Imhkc2ZkcyIsImlhdCI6MTUwNjc5MTYzMn0.x1oCejqbDVv_xnmqKTdMoMNMzKyV_qqWpjekCqsgLtM";
let jsonPatch = {
    jsonObject: {
        baz: "qux",
        foo: "bar"
...
let imageUrl =
    "https://upload.wikimedia.org/wikipedia/commons/f/fc/MarkZuckerberg-crop.jpg";
...
describe("Thumbnail Generations", function() {
    ...
    it("should return error if image size exceeds than 10 MB", function(done) {
        let urlImage =
            "https://upload.wikimedia.org/wikipedia/commons/9/93/Canon_EF_16-35mm_f4L_IS_USM_collage.jpg";
        chai
            .request(server)
            .post(url + urlImage)
            .set("Authorization", token)
